...
export class AuthService {
	...
	getUserProfileData(): Observable<any[]> {
		...
		return this.http.get<any>(`https://winitclinic.dev.eltex.dev/api/v1/accounts/me`, { headers }).pipe(retry(2));
	}
	...
	getUserHealthProfile(id: any): Observable<any[]> {
		...
		return this.http.get<any>(`https://winitclinic.dev.eltex.dev/api/v1/patient/health-profiles/` + id, { headers }).pipe(retry(2));
	}
