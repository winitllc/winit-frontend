...
export class AddProductModalComponent {
  ...
  public sectionStates: AddSectionModel[] = [{
  ...
  updateProduct(section: AddSectionModel): void {
    console.log(`AddProductModalComponent.updateProduct: setting product name: ${JSON.stringify(section)}`);
  ...
  public updateSectionState(index: number, section: AddSectionModel): void {
    // this.zone.run(() => {
      this.sectionStates[index] = Object.assign({}, section);
    // });
  }

  public confirmSection(): void {
    // this.zone.run(() => {
  ...
  selectSection(sectionIndex: number): void {
    // this.zone.run(() => {
      console.log(`AddProductModalComponent.selectSection: going back a ${sectionIndex}`);
  ...
  async confirmSubmitProduct(): Promise<void> {
    console.log(`AddProductModalComponent.confirmSubmitProduct: submit product confirmed`);
    // try {
  ...
  public submitProduct(): void {
    console.log(`AddProductModalComponent.submitProduct: submit product selected`);
  ...
  cancelModal(): void {
    console.log(`AddProductModalComponent.cancelModal: modal canceled`);
    this.modalController.dismiss();
  }

  async nameSection(): Promise<void> {
    console.log(`AddProductModalComponent.nameSection: name section selected`);
    // try {
  ...
  async imageSection(): Promise<void> {
    console.log(`AddProductModalComponent.imageSection: image section selected`);
    // try {
    //   this.currentSection.loading = true;
  ...
  async ingredientsSection(): Promise<void> {
    console.log(`AddProductModalComponent.ingredientsSection: ingredients section selected`);
    // try {
    //   this.currentSection.loading = true;
    //   const imageToText: ImageToTextData = await this.imageToText();
  ...
  // public async imageToText(): Promise<ImageToTextData> {
  ...
  // public async captureAndCropImage(): Promise<string> {
  //   console.log(`AddProductModalComponent.captureAnd: ingredients section selected`);
  //   try {
  ...
  public setCurrentSectionData(croppedImageData: string, text?: string, ingredientsSections?: IngredientsSections): void {
  ...
  resetSection(): void {
    console.log(`AddProductModalComponent.resetSection: reset section selected`);
    // this.zone.run(() => {
  ...
  //   console.log(`AddProductModalComponent.captureImage: capture image selected`);
  //   try {
  ...
  public async presentConfirmSectionModal(sectionName: string, sectionImageData: string, text?: string, ingredientsSections?: IngredientsSections): Promise<void> {
    console.log(`AddProductModalComponent.presentConfirmSectionModal: present confirmation section modal`);
  ...
  // public async presentCropImageModal(imageBase64: string): Promise<string> {
  //   return new Promise((resolve, reject) => {
  ...
  public async presentConfirmProductModal(): Promise<void> {
    console.log(`AddProductModalComponent.presentConfirmProduct: present confirm product modal selected`);
  ...
  public async calculateReward(): Promise<void> {
    console.log(`AddProductModalComponent.calculateReward: calculate reward triggered`);
    // this.profileService.addToProfilePoints(AppConfig.pointAwards.addProduct[this.feedback.confirmedSectionsLength]);
  }

  public updateFeedbackSections(section: string, remove: boolean): void {
    console.log(`AddProductModalComponent.updateFeedbackSections: update feedback sections`);
    // this.zone.run(() => {
  ...
  // public calculateNextSectionIndex(): number {
  //   console.log(`AddProductModalComponent.ingredientsSection: calculate next section index triggered`);
  //   return Math.min(this.currentSectionIndex + 1, this.sectionStates.length - 1);
  // }

  // public calculatePreviousSectionIndex(): number {
  //   return Math.max(this.currentSectionIndex - 1, 0);
  // }

  // public singleOrDoubleText(ingredientsText: string): boolean {
  ...
  // public extractSectionTokens(ingredientsText: string): string[] {
  ...
  // public extractSections(ingredientsText: string, sectionTokens: string[]): string[] {
  //   const sections = [];
  //   let section: string;
  ...
  // public extractIngredientsSections(ingredientsText: string): IngredientsSections {
  ...
  // public async presentConfirm(message: string, retryHandler: () => any) {
